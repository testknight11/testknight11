...
function Cart() {
  ...
  const {
    onRemove, toggleCartItemQuantity, totalPrice, totalQuantities, cartItems, setShowCart,
  } = useStateContext()
                ...
                <div className="flex bottom">
                  <div>
                    <p style={{ display: 'flex', justifyContent: 'center', alignContent: 'center' }} className="quantity-desc">
                      <span style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} className="minus" onClick={() => toggleCartItemQuantity(item._id, 'dec')}>
                      ...
                      <span style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} className="plus" onClick={() => toggleCartItemQuantity(item._id, 'inc')}>
